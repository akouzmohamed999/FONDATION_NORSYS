...
DROP TABLE IF EXISTS CONTACT_ACTIVITE;

CREATE TABLE CONTACT_ACTIVITE (
  ID_ACTIVITE int(11) NOT NULL,
  ID_CONTACT int(11) NOT NULL,
  CONSTRAINT FK9C502ED43F79B958 FOREIGN KEY (ID_ACTIVITE) REFERENCES ACTIVITE (ID_ACTIVITE),
  CONSTRAINT FK9C502ED46E541741 FOREIGN KEY (ID_CONTACT) REFERENCES CONTACT (ID_CONTACT)
);
