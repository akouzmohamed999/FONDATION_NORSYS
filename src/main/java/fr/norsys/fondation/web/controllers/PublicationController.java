...
public class PublicationController {
	...
	public ResponseEntity<?> uploadFile(@RequestParam("file") MultipartFile uploadfile,@RequestParam("idPublication") int idPublication) {
		...
		try {
			System.out.println("TITTTRRRE :"+idPublication);
			Publication publication = this.publicationSerivce.findPublicationById(idPublication);
			System.out.println("LLLLLLLLLLLLLL "+publication +" FILE "+uploadfile);
